...
$Phone = "0508-202-4743"
$Tel = "tel:05082024743"
$BaseUrl = "https://massagenara.netlify.app"
$Author = "마사지나라 콘텐츠팀"
...
$verification<meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1">
...
<footer class="site-footer">
  <div class="footer-wrap">
    ...
    <div class="company-info">
      <span>회사: $Company</span><span>대표: $Representative</span><span>사업자등록번호: $BusinessNumber</span><span>주소: $CompanyAddress</span><span>브랜드: $Brand</span><span>개인정보보호 책임자: 운영 책임자</span>
    </div>
...
function JsonLd($Type, $Title, $Description, $Path, $FaqJson) {
  $url = "$BaseUrl$Path"
  return @"
<script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"$BaseUrl/#org","name":"$Brand","legalName":"$Company","alternateName":"$Brand","taxID":"$BusinessNumber","founder":{"@type":"Person","name":"$Representative"},"address":{"@type":"PostalAddress","streetAddress":"청석로 268","addressLocality":"파주시","addressRegion":"경기도","addressCountry":"KR"},"url":"$BaseUrl/","telephone":"$Phone","contactPoint":{"@type":"ContactPoint","telephone":"$Phone","contactType":"customer support","areaServed":"KR","availableLanguage":"ko"}},{"@type":"WebSite","@id":"$BaseUrl/#website","name":"$Brand","url":"$BaseUrl/","publisher":{"@id":"$BaseUrl/#org"}},{"@type":"LocalBusiness","@id":"$BaseUrl/#local","name":"$Brand","legalName":"$Company","taxID":"$BusinessNumber","address":{"@type":"PostalAddress","streetAddress":"청석로 268","addressLocality":"파주시","addressRegion":"경기도","addressCountry":"KR"},"url":"$BaseUrl/","telephone":"$Phone","priceRange":"상담 후 확정","areaServed":["서울","경기","인천","부산"],"openingHoursSpecification":{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],"opens":"10:00","closes":"02:00"}},{"@type":"Article","headline":"$(Escape-Json $Title)","description":"$(Escape-Json $Description)","author":{"@type":"Organization","name":"$Author"},"reviewedBy":{"@type":"Organization","name":"$Reviewer"},"dateModified":"$Today","mainEntityOfPage":"$url"},{"@type":"FAQPage",$FaqJson}]}</script>
"@
}
...
function HomePage {
  ...
  $serviceCards = ($Services | ForEach-Object { "<a class=""svc service-card reveal"" href=""/services/$($_.Slug)/""><span>$($_.Name)</span><h3>$($_.Tone)</h3><p>예약 전 관리 범위, 시간, 비용을 먼저 안내합니다.</p><strong>$($_.Price)</strong></a>" }) -join ""
  $regionCards = ($Regions | ForEach-Object { "<a class=""reg reveal"" href=""/locations/$($_.Slug)/""><span>$($_.Name)</span><h3>$($_.Areas.Count)개 권역 안내</h3><p>구·동 단위 상세 페이지에서 이동 조건과 준비 사항을 확인할 수 있습니다.</p></a>" }) -join ""
  $copy = "마사지나라의 출장마사지 예약 서비스는 건전 출장마사지, 피로 관리, 예약제 운영을 기준으로 안내합니다. 고객이 먼저 확인해야 할 것은 서비스명이 아니라 관리 범위, 가격, 출장 가능 지역, 취소 조건, 불법·퇴폐 서비스 제공 불가 원칙입니다. 이 홈 페이지는 검색 키워드를 반복하기보다 실제 예약 전에 필요한 정보를 순서대로 배치했습니다.`n`n문의가 들어오면 현재 지역, 희망 시간, 인원, 공간 조건, 원하는 관리 강도를 확인합니다. 이후 출장 가능 여부와 가격, 출장비, 취소 기준을 사전에 안내하고 고객이 동의한 경우에만 예약을 확정합니다. 모든 안내는 의료 행위가 아닌 휴식형 웰니스 서비스 기준이며, 통증이나 질환이 있으면 의료 전문가 상담이 우선입니다.`n`n현재 바로 연결되는 상담 방법은 전화와 문자입니다. 카카오톡 상담과 온라인 예약폼은 공식 채널 주소, 개인정보 수신처, 보관 기준이 확정된 뒤 추가합니다. 확인되지 않은 링크를 먼저 노출하기보다 실제로 연결되는 방법만 안내하는 편이 고객에게 더 안전합니다."
  $notes = NoteCards @(
...
<section class="wrap home-section trust-band"><div class="trust-grid"><article><span>01</span><h3>건전 서비스</h3><p>휴식과 피로 관리를 위한 예약형 웰니스 서비스만 안내합니다.</p></article><article><span>02</span><h3>가격 사전 안내</h3><p>코스 비용과 출장비는 예약 확정 전에 먼저 설명합니다.</p></article><article><span>03</span><h3>예약제 운영</h3><p>지역, 시간, 공간 조건을 확인한 뒤 가능한 일정만 배정합니다.</p></article><article><span>04</span><h3>불법 서비스 불가</h3><p>불법·퇴폐 요청은 상담 단계 또는 현장에서 진행하지 않습니다.</p></article></div></section>
<section class="wrap home-section"><div class="section-head"><span class="eyebrow">SERVICE GUIDE</span><h2>서비스 안내</h2><p>원하는 이름보다 중요한 것은 관리 목적과 강도입니다. 상담 시 피로 부위와 선호 압을 알려주시면 가능한 코스를 안내합니다.</p></div><div class="card-grid">$serviceCards</div></section>
<section class="wrap home-section" id="region"><div class="section-head"><span class="eyebrow">SERVICE AREA</span><h2>출장 가능 지역</h2><p>서울, 경기, 인천, 부산의 주요 권역을 정리했습니다. 세부 페이지에서 행정구와 행정동 정보를 확인할 수 있습니다.</p></div><div class="card-grid">$regionCards</div></section>
<section class="wrap home-section price-section"><div class="section-head"><span class="eyebrow">PRICE</span><h2>가격 안내</h2><p class="source-note">서비스별 시작가는 상담 기준이며, 출장비는 지역과 시간대에 따라 예약 전 별도로 안내합니다.</p></div>$(PriceGrid)</section>
<section class="wrap home-section process"><div class="section-head"><span class="eyebrow">PROCESS</span><h2>이용 절차</h2><p>처음 이용하는 고객도 흐름을 알 수 있도록 상담부터 관리 진행까지 필요한 확인 순서를 공개합니다.</p></div><ol class="process-list"><li><span>01</span><b>문의</b><p>전화 또는 문자로 현재 지역과 희망 시간을 남깁니다.</p></li><li><span>02</span><b>지역 확인</b><p>이동 가능 여부와 예상 도착 시간을 확인합니다.</p></li><li><span>03</span><b>가격 안내</b><p>코스 비용, 출장비, 취소 기준을 먼저 안내합니다.</p></li><li><span>04</span><b>예약 확정</b><p>고객이 조건에 동의하면 시간과 관리 범위를 확정합니다.</p></li><li><span>05</span><b>방문</b><p>관리사가 안내된 장소로 이동하고 현장 조건을 다시 확인합니다.</p></li><li><span>06</span><b>관리 진행</b><p>휴식형 관리 범위 안에서 컨디션에 맞춰 진행합니다.</p></li></ol></section>
<section class="wrap home-section prose policy-panel"><div class="section-head"><span class="eyebrow">POLICY</span><h2>운영 정책</h2><p>검색용 문구보다 실제 예약 전 고객이 알아야 할 기준을 먼저 보여드립니다.</p></div><div class="policy-layout"><div class="copy"><p>$($copy -replace "`n`n","</p><p>")</p></div><aside class="policy-check"><h3>예약 전 확인</h3><ul><li>휴식형 관리이며 의료 행위가 아닙니다.</li><li>불법·퇴폐 서비스는 제공하지 않습니다.</li><li>가격과 출장비는 확정 전 안내합니다.</li><li>현장 조건이 다르면 진행이 조정될 수 있습니다.</li></ul></aside></div></section>
<section class="wrap home-section notes">$notes</section>
<section class="wrap home-section reviews"><div class="section-head"><span class="eyebrow">REVIEWS</span><h2>후기 운영 기준</h2><p>후기는 고객을 속이는 장식이 아니라 예약 판단에 도움이 되는 확인 정보여야 합니다.</p></div><div class="card-grid"><article class="svc"><span>공개 동의</span><h3>실제 이용 후기만 반영</h3><p>개인 식별 정보와 과장 표현은 제외하고, 예약 과정에서 확인 가능한 응대·시간·공간 준비 중심으로 관리합니다.</p></article><article class="svc"><span>허위 후기 불가</span><h3>가짜 평점 사용 안 함</h3><p>확인되지 않은 후기를 임의로 만들지 않으며, 공개 가능한 실제 후기 자료가 확보된 경우에만 추가합니다.</p></article></div></section>
<section class="wrap home-section reservation-panel" id="reservation-form"><div class="section-head"><span class="eyebrow">RESERVATION</span><h2>예약 문의</h2><p>지금 연결 가능한 상담 수단만 크게 보여드립니다. 없는 채널을 연결된 것처럼 보이게 만들지 않습니다.</p></div><div class="reservation-grid"><a class="reservation-card primary" href="$Tel"><span>전화 상담</span><h3>$Phone</h3><p>가장 빠른 예약 확인 방법입니다.</p></a><a class="reservation-card" href="sms:05082024743"><span>문자 상담</span><h3>지역과 희망 시간 남기기</h3><p>확인 후 가능 코스와 예상 시간을 안내합니다.</p></a></div><p class="channel-note">카카오톡 상담과 온라인 예약폼은 공식 채널 URL과 개인정보 수신 기준이 확정된 뒤 추가합니다.</p></section>
"@
